...
public class NovoTituloActivity extends AppCompatActivity {
    ...
    private void setupImagePickers() {
        ...
        pickImageLauncher = registerForActivityResult(
                ...
                uri -> {
                    if (uri != null) {
                        ...
                        // Persistência de permissão (somente se suportada)
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                            try {
                                ...
                                Log.w(TAG, "URI não persistível: " + selectedImageUri.toString());
                            }
                        }
        ...
        imageViewPreviewCapa.setOnClickListener(v -> checkPermissionAndOpenPicker());
    }
    ...
    private void setupButtons() {
        ...
        btnAdicionar.setOnClickListener(v -> adicionarTitulo());
    }
    ...
    private void adicionarTitulo() {
        ...
        try {
            ...
            Toast.makeText(this, "Insira uma nota válida (0 a 10).", Toast.LENGTH_SHORT).show();
            return;
        }
